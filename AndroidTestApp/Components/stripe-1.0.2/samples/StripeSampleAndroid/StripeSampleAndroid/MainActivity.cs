...
{
	[Activity (Label = "Stripe Sample", MainLauncher = true, Theme = "@android:style/Theme.Holo.Light")]
	public class MainActivity : Activity
	{
		public const string STRIPE_PUBLISHABLE_KEY = "pk_YT1CEhhujd0bklb2KGQZiaL3iTzj3";
