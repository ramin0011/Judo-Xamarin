...
namespace StripeSampleiOS
{
	public class MainViewController : UIViewController, IStripeTestPaymentAuthorizationViewControllerDelegate, IPKPaymentAuthorizationViewControllerDelegate
	{
		...
		public async void DidAuthorizePayment (PKPaymentAuthorizationViewController controller, PKPayment payment, PKPaymentAuthorizationHandler completion)
		{
            await HandlePaymentAuthorization (payment, status => completion(status));
		}
		...
		void BeginPayment ()
		{
			var merchantId = "REPLACE this with your Apple Merchant ID";
