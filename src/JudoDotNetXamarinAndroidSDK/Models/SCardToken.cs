...
{
    public class SCardToken : Object, IParcelable
    {
        ...
        public SCardToken (Parcel parcel)
        {
        ...
        public static SCardToken InitCardToken (string token, string consumerToken, string cv2, CardType cardType, string expiryDate = null, string firstSix = null, string lastfour = null)
        {
            SCardToken cd = new SCardToken ();
    ...
    public class CardTokenCreator : Object, IParcelableCreator
    {
        ...
        {
            return new SCardToken (source);
        }

        public Object[] NewArray (int size)
        {
            return new SCardToken[size];
        }
    }
}