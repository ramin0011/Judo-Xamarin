...
namespace JudoDotNetXamarinAndroidSDK.Ui
{
    public class CardExpiryCV2TextView : BackgroundHintTextView
    {
        ...
        {
            // Set our hint text
            SetHintText (Judo.GetExpiryAndValidationHintFormat (CardType.UNKNOWN));
            // Set error text
        ...
        public void ValidateExpiryDate (string expiry)
        {
            if (!string.IsNullOrWhiteSpace (expiry)) {
                ...
                var daysInThisMonth = DateTime.DaysInMonth (yearNumber, monthNumber);
                var expiryDate = new DateTime (yearNumber, monthNumber, daysInThisMonth, 23, 59, 59);
